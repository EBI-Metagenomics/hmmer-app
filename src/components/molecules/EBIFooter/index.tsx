...
export const EBIFooter: React.FC = () => {
    return (
        <footer className="vf-u-margin__top--1200 vf-footer">
            <div className="vf-footer__inner">
                <p className="vf-footer__notice">
                    HMMER Web is free to use, including for commercial purposes (see our{" "}
                    <a className="vf-footer__link" href="//www.ebi.ac.uk/about/terms-of-use/">
                        <u>terms of use</u>
                    </a>{" "}
                    for more). Target databases have various open licenses - for a general overview see{" "}
                    <a className="vf-footer__link" href="//www.ebi.ac.uk/licencing">
                        <u>EBI's licensing page</u>
                    </a>
                    . This service imposes no additional restriction on the use of the contributed data than those
                ...
                <div className="vf-footer__links-group | vf-grid">
                    ...
                    <div className="vf-links">
                        ...
                        <ul className="vf-links__list | vf-list">
                            <li className="vf-list__item">
                                <a href="//www.ebi.ac.uk/about/faq" className="vf-list__link">
                                    FAQ
                                </a>
                            </li>
                            <li className="vf-list__item">
                ...
                <p className="vf-footer__legal">
                    <span className="vf-footer__legal-text">Copyright © EMBL {new Date().getFullYear()}</span>
                    <span className="vf-footer__legal-text">
